		...
		<div className="section">
			<Container>
				<Row className="justify-content-between align-items-center mt-5 mb-5">
					<Col md={12}>
					    <h1 className="h5 text-uppercase text-muted text-center" data-sal="slide-down" data-sal-delay="150" data-sal-easing="ease">Our Clients</h1>
						<h3 className="h1 mb-4 text-center" data-sal="slide-down" data-sal-delay="100" data-sal-easing="ease">Trusted by over 300+ clients</h3>
