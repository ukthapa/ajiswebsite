...
import aboutImg from "../images/example2.png"
		...
		<div className="section">
			<Container>
				<Row className="justify-content-between align-items-center mt-5 mb-5">
					<Col md={5}>
					    <h2 className="h5 text-uppercase text-muted " data-sal="slide-down" data-sal-delay="150" data-sal-easing="ease">Why Choose Us</h2>
