			...
			<section className="wrapper mb-5 mt-0">
				<Container>
					<Row className="justify-content-md-center align-items-md-center p-0">
						<Col lg={10} data-sal="slide-up" data-sal-delay="50" data-sal-easing="ease">
			...
			<section>
				<Container>
					<Row  className="justify-content-center pt-4">
						<Col md={8}>
							<h2 className="text-center" data-sal="slide-up" data-sal-delay="300" data-sal-easing="ease">Drop Us a Line</h2>
							<p className="text-center" data-sal="slide-up" data-sal-delay="350" data-sal-easing="ease">Reach out to us from our contact form and we will get back to you shortly.</p>
							<div className="pt-4 pb-5 mb-4" data-sal="slide-up" data-sal-delay="350" data-sal-easing="ease">
							<ContactForm />
							</div>
						</Col>
					</Row>
